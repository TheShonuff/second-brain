...
# LightDM
Default Endeavor OS background path = */usr/share/endevouros/backgrounds/*
Config path: */etc/lightdm*
Setup Dual monitor differnet backgrounds
...
```
### Links
[LightDM screen mix-uo](https://askubuntu.com/questions/1187657/ubuntu-xfce-lightdm-login-screen-background-mix-up-on-multiple-monitors)
